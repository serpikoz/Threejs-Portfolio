...
const Contact = () => {
    ...
    emailjs
      .send(
        ...
        "template_12wfqkn",
        {
          ...
          to_email: "kadir-ozyurek@outlook.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert(
            "Teşekkürler.Mailiniz ulaştı,sizinle iletişime geçilecektir :)"
          );
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>Hemen Ulaş!</p>
        ...
        >
          ...
          >
            {loading ? "Neredeyse tamam..." : "Gönder"}
          </button>
        </form>
      </motion.div>
...
export default SectionWrapper(Contact, "iletişim");
